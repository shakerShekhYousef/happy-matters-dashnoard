...
class LandlordsResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        'iban' => $this->iban,
        'swift' => $this->swift,
        'options' => $this->options == 1  ? 'send push notifications' : ($this->type == 2 ? 'send email notification' : 'auto hold amount in wallet' ),
        'notes' => $this->notes,
