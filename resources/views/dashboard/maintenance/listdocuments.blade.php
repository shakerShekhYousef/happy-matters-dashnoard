                        ...
                        <table id="datatable-buttons" class="table table-bordered" style=" width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th class="td-center-content-10">document type</th>
                                </tr>
                            </thead>
                                ...
                                @forelse($maintenances as $maintenance)
                                    <tr>
                                        <td class="td-center-content">
                                            <a href="{{ asset($maintenance->name) }}" target="_blank">Doc<img
                                                    src="{{ asset('assets/images/pdf.png') }}" alt="" width="50"
                                                    height="50"></a>
                                        </td>
                                        <td class="td-center-content">{{ $maintenance['type'] }}</td>
                                    </tr>
                                @empty
                                    <th>No documents found</th>
                                @endforelse
