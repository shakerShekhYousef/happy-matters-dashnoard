                ...
                <div class="card-body">
                    ...
                    <div style="overflow-x:auto;">
                        <table id="datatable-buttons" class="table table-bordered" style=" width: 100%;">
                            <thead>
                                <tr>
                                    <th class="td-center-content  th-center-content-5">Guest type</th>
                                    <th class="td-center-content  th-center-content-5">Name</th>
                                    <th class="td-center-content  th-center-content-5">Age</th>
                                    <th class="td-center-content  th-center-content-5">Nationality</th>
                                </tr>
                            </thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="td-center-content">{{ $tenant['guest_type'] }}</td>
                                    <td class="td-center-content">{{ $tenant['name'] }}</td>
                                    <td class="td-center-content">{{ $tenant['age'] }}</td>
                                    <td class="td-center-content">{{ $tenant['nationality'] }}</td>
